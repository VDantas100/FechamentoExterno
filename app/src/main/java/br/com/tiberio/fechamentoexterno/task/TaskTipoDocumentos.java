...
/**
 * Created by Vinicius.Dantas on 14/03/2018.
 */

public class TaskTipoDocumentos   extends AsyncTask <String,String,List<String>> {

    Context context;
    ProgressDialog progressDialog;


    public TaskTipoDocumentos(Context context) {
    ...
    protected List<String> doInBackground(String... strings) {
        try {
            ...
            res = wssoap.RetornarTipoDocumentosEmp(usuario,nomeproduto );
