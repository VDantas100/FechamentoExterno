...
public class TaskArquivos extends AsyncTask <String,String,List<String>> {

    Context context;
    ProgressDialog progressDialog;


    public TaskArquivos(Context context) {
    ...
    protected List<String> doInBackground(String... strings) {
        ...
        try {
            ...
            res = wssoap.RetornarArquivosEmp(usuario,nomeproduto,tipodocumento);
