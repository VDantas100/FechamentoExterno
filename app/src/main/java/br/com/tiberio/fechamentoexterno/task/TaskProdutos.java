...
public class TaskProdutos extends AsyncTask <String,String,List<String>>{

    Context context;
    ProgressDialog progressDialog;


    public TaskProdutos(Context context) {
    ...
    protected List<String> doInBackground(String... strings) {
        try {
            ...
            res = wssoap.RetornarListaProdEmp( parametro.toString() );
