...
public class TaskTipoArquivosOC extends AsyncTask<String,String,List<String>> {

    Context context;
    ProgressDialog progressDialog;


    public TaskTipoArquivosOC(Context context) {
    ...
    protected List<String> doInBackground(String... strings) {
        ...
        try {
            ...
            Log.i( "nomeproduto: " + tipodocumento1, "doInBackground: " + tipodocumento1);
            ...
            res = wssoap.RetornarArquivosOC(usuario,tipodocumento1, tipodocumento2 );
