...
public class TaskTipoDocumentos1 extends AsyncTask <String,String,List<String>> {

    Context context;
    ProgressDialog progressDialog;

    public TaskTipoDocumentos1(Context context) {
    ...
    protected List<String> doInBackground(String... strings) {
        try {
            ...
            res = wssoap.RetornarListaTipoDocumentos1(usuario,nomelocalidade,nomebairro,nomeproduto );
