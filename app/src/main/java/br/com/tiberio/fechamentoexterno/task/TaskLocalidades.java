...
public class TaskLocalidades extends AsyncTask <String,String,List<String>>{
    Context context;
    ProgressDialog progressDialog;

    public TaskLocalidades(Context context) {
    ...
    protected List<String> doInBackground(String... strings) {
        try {
            ...
            res = wssoap.RetornarListaLocalidades( parametro.toString() );
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage("Buscando Localidades, por favor, aguarde alguns instantes.");
